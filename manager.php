                ...
                <div class="col-md-3">
                    <div class="card shadow border-warning mb-3" style="border-left: .25rem solid #f6c23e;border-radius: 0.36rem">
                        <div class="card-body">
                            ...
                            $sql_countTicket = mysqli_query($conn, "SELECT SUM(sold) FROM `movie`");
                            $countTicket = mysqli_fetch_array($sql_countTicket);
                            ?>
                            <p class="card-text"><?php echo "$countTicket[0] Vé" ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
